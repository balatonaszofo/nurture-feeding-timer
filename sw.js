const CACHE = "nurture-day-v33";
const ASSETS = [
  "./", "./index.html", "./styles.css?v=32", "./push-config.js?v=27", "./firebase-config.js?v=27",
  "./identity-core.js?v=32", "./analytics.js?v=30", "./native-bridge.js?v=27", "./auth.js?v=33", "./app.js?v=33", "./manifest.webmanifest?v=27", "./icon.svg?v=20",
