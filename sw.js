const CACHE = "nurture-v18";
const ASSETS = [
  "./", "./index.html", "./styles.css?v=18", "./push-config.js?v=18", "./firebase-config.js?v=18",
  "./identity-core.js", "./auth.js?v=18", "./app.js?v=18", "./manifest.webmanifest?v=18", "./icon.svg"
];
