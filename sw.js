const CACHE = "nurture-daily-v21";
const ASSETS = [
  "./", "./index.html", "./styles.css?v=21", "./push-config.js?v=21", "./firebase-config.js?v=21",
  "./identity-core.js", "./auth.js?v=21", "./app.js?v=21", "./manifest.webmanifest?v=20", "./icon.svg?v=20",
