const CACHE = "nurture-daily-v22";
const ASSETS = [
  "./", "./index.html", "./styles.css?v=22", "./push-config.js?v=22", "./firebase-config.js?v=22",
  "./identity-core.js?v=22", "./auth.js?v=22", "./app.js?v=22", "./manifest.webmanifest?v=22", "./icon.svg?v=20",
