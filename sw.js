const CACHE = "nurture-daily-v23";
const ASSETS = [
  "./", "./index.html", "./styles.css?v=23", "./push-config.js?v=23", "./firebase-config.js?v=23",
  "./identity-core.js?v=23", "./auth.js?v=23", "./app.js?v=23", "./manifest.webmanifest?v=22", "./icon.svg?v=20",
